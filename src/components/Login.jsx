      ...
      <div className="hidden lg:block relative w-1/2 bg-gradient-to-br from-primary-50 to-primary-100">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <div className="max-w-lg text-center">
            {/* Testing Dashboard Animation */}
            <div className="bg-white rounded-2xl shadow-2xl p-8 mb-8">
              <div className="space-y-4">
                {/* Mock dashboard header */}
                <div className="flex items-center justify-between mb-4">
                  <h4 className="text-lg font-semibold text-gray-800">Test Dashboard</h4>
                ...
                <div className="grid grid-cols-3 gap-4 mb-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600">23ms</div>
                ...
                <div className="bg-gray-50 rounded-lg p-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-600">User Authentication</span>
                      <span className="text-xs text-green-600 font-medium">✓ Passed</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-600">Payment Integration</span>
                      <span className="text-xs text-green-600 font-medium">✓ Passed</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-gray-600">API Load Test</span>
                      <span className="text-xs text-yellow-600 font-medium animate-pulse">⏳ Running</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-primary-50 rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-primary-800">AI Insights</span>
                  </div>
                  <p className="text-xs text-primary-700">
                    Detected potential performance optimization in checkout flow.
                  </p>
                </div>
              </div>
            </div>
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Welcome Back to AI Test Master
            </h3>
            <p className="text-gray-600 leading-relaxed">
              Continue your intelligent testing journey. Access your dashboard, 
              review test results, and optimize your application's performance.
            </p>
          </div>
        </div>
      </div>
